"""
Django settings for trainee_metadata_rules project.
...
APP_NAME = 'trainee_metadata_rules'
...
INSTALLED_APPS = [
    ...
    'trainee_metadata_rules.apps.EdcVisitTrackingAppConfig',
    'trainee_metadata_rules.apps.EdcMetadataAppConfig',
...
ROOT_URLCONF = 'trainee_metadata_rules.urls'
...
WSGI_APPLICATION = 'trainee_metadata_rules.wsgi.application'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'trainee_metadata_rules', 'static')
